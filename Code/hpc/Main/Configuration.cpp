...
Configuration::Configuration(double lowerBound, double upperBound, double acceleration, std::string schema, unsigned int numberOfPoints, std::vector<double> timeLevels, double cfl)
